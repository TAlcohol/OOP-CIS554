...
int main() {
	...
	try {
		...
		cout << i / j;
        // once you figure out why j accidentally to be 0, you fix it, you may
        // remove the throw statement, and release some kind of patch
        ...
        // like "Error code: 105", it could be meaningful for developers
	}
	catch (char const* s) { cout << "cannot divide by 0" << endl; }
	//Catch all string message thrown
    // catch (char s) seems ok
    // catch (char const* s) is inherited from c language
