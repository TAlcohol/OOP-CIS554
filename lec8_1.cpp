...
/*
initializer_list is the same level as the constructor
so initializer_list will not evoke constructor
but sometime, like this, you need constructor to make head and tail = nullptr

This method could tell the system to evoke constructor first
visual studio will do this thing for you, but some complier will not
so add ":[constructor]" is a safer way
...
you also can just put "head = tail = nullptr;" into initializer_list

but sometime, constructor do lots of things
...
int main() {
    ...
    while (in1 >> i) { //while not reaching end of file ....
		// in1 >> i;
		V.push_back(i);
	}

    // This is a more safe strategy
    // because if there is a space at the end of file, the last
    // character will print twice by using "!in1.eof()"
