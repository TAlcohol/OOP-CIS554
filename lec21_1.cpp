...
// there are 3 inheritance mode, public, protected, private
...
// protected, private
// private only allow functions of this class to access
// protected only allow functions of this class to access, but it could be inherit

// constructors(normal, copy, move) needs to be public mode, or it won't be accessed

// if a function is defined virtual, the function remains virtual in the hierarchy
// although sometimes you do not put "virtual" before the function in the derived class

// abstract class: include pure virtual functions
// it considered a in-complete class, you can not have a object of this class
// every class inherit this abstract class, need define the pure virtual member